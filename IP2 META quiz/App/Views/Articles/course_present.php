...
$sql_questions = "SELECT question_id, question_text FROM Admin_Questions WHERE quiz_id = '$quiz_id' ";
...
if (mysqli_num_rows($result_questions) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result_questions)) {
        ...
        $sql_options = "SELECT question_1, question_2, question_3, question_4 FROM Admin_Options WHERE question_id = " . $row['question_id'];
