...
<body>
    ...
    <div class="rounded-box">
        <div class="button-container">
            <a href="course_selection_for_users.php">
                <button class="btn-back">Back to Course Selection</button>
            </a>
        </div>
    </div>
</div>
...
echo $user_id;
$temps="SELECT * from user_quizzes where quiz_id='$quizId' and user_id='$user_id' ";
$result=mysqli_query($conn,$temps);
if(mysqli_num_rows($result)==0){
    $sqlInsertQuiz = "INSERT INTO user_quizzes (quiz_name, quiz_id,user_id) VALUES (?, ?,?)";
$stmt = $conn->prepare($sqlInsertQuiz);
$stmt->bind_param("ssi", $quizName, $quizId,$user_id);
$stmt->execute();
}
